...
<(META)>:
	...
	name: Gmail Extension Python Document
	description: >
	version: 0.0.0.0.0.0
...
try:
	...
	pass
#=======================================================================||
from worldbridger.social import google#			||
#=======================================================================||
here = os.path.join(os.path.dirname(__file__),'')#						||
log = True
#=======================================================================||
class GMailViewer(google.client):
	''' '''
	def __init__(self):
...
class GMailWriter(google.client):
...
class GMailAdministrator(GMailViewer):
